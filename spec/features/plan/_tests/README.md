...
| Scenario | Validates |
|---|---|
| [plan-file-structure](plan-file-structure.md) | [plan#req:plan-file](../README.md#req-plan-file), [plan#req:plan-slug-format](../README.md#req-plan-slug-format) |
...
| [index-structure](index-structure.md) | [plans-index#req:required-sections](../../plans-index/README.md#req-required-sections), [plans-index#req:sub-plan-indentation](../../plans-index/README.md#req-sub-plan-indentation), [plans-index#req:contents-columns](../../plans-index/README.md#req-contents-columns), [plans-index#req:recently-closed-present](../../plans-index/README.md#req-recently-closed-present) |
