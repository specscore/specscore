...
| [new-artefact-template-gallery](new-artefact-template-gallery/README.md) | Draft | — | https://specscore.md/feature-specification | — | — | Publishes the canonical new-artefact templates as raw Markdown files on specscore.md — one per artefact type at /new/<type>.md, with a browsable index at /new/. |
