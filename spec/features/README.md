...
| [feature](feature/README.md) | Amending | Document | `https://specscore.md/feature-specification` | `spec/features/**/README.md` | [features-index](features-index/README.md) | Feature specification structure, metadata, lifecycle, and conventions |
...
| [drift-recap](drift-recap/README.md) | In Review | — | https://specscore.md/feature-specification | — | — | Formalizes the existing machine-generated per-AC spec-vs-code drift recap as a first-class, status-less SpecScore document type: registry row, format frontmatter, and a lint contract for its YAML summary block. |
...
| [unify-task-status-vocabulary](unify-task-status-vocabulary/README.md) | Approved | — | https://specscore.md/feature-specification | — | — | Establishes the 7-value Task status enum (planning, queued, in_progress, blocked, complete, failed, aborted) as the single canonical task-status vocabulary across every surface: the Task entity, plan-inline task blocks, the plan-new scaffold, the execution-band rollup, the task change-status verb, and the implement skill. Replaces the divergent pending/in-progress/done/blocked token set; lint --fix auto-migrates legacy tokens. |
| [graphspec](graphspec/README.md) | Draft | Document | `https://specscore.md/feature-specification` | `spec/features/graphspec/` | — | Bootstrap specification language for connected domain models. |
| [modelspec-validation](modelspec-validation/README.md) | Draft | Document | `https://specscore.md/feature-specification` | `spec/features/modelspec-validation/` | — | SpecScore validation support for independent ModelSpec documents. |
