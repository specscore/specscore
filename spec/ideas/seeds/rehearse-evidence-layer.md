...
**Promoted (2026-07-10):** full Idea with current stage, end state, v1 roadmap, and the standalone-vs-stack coupling rationale now lives at `specscore/rehearse` → spec/ideas/rehearse-evidence-layer.md (commit 6eab967).
